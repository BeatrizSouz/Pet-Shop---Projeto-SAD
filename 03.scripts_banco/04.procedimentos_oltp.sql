...
BEGIN
    ...
    INSERT INTO staging.stg_atendimento (
        cod_atendimento, 
        cod_tipo_servico, 
        cod_filial, 
        cod_funcionario, 
        ...
        cod_quadro_clinico, 
        cod_turno, 
        cod_funcao_principal, 
        cod_funcao_secundaria, 
        data_inicio, 
        data_fim, 
        prioridade, 
        valor, 
    ...
    SELECT 
        ...
        a.cod_turno, 
        fu.cod_funcao AS cod_funcao_principal,        
        fu.cod_funcao_secundaria,                     
        a.data_inicio, 
        a.data_fim, 
        a.prioridade, 
        ts.valor_servico AS valor, 
        @data_carga
